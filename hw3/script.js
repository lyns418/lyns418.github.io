...
let x1 = 0, y1 = 0, dx1 = 5, dy1 = 5, r1 = 30, color1 = "#" + Math.floor(Math.random() * 16777215).toString(16).padStart(6, '0');
let x2 = canvas.width, y2 = 0, dx2 = 5, dy2 = 5, r2 = 30, color2 =  "#" + Math.floor(Math.random() * 16777215).toString(16).padStart(6, '0');
